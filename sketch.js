...
for (var i = 0; i < trajectory.length; i++) {
  //console.log("playerArrows[0].trajectory[0]"+this.trajectory[i]);

  //ellipse(100,100,10,10);

//  console.log("this.trajectory[i].posX="+this.trajectory[i][0]);

  ellipse(this.trajectory[i][0],this.trajectory[i][1],10,5);
